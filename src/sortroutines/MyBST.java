...
public class MyBST extends Sorter {
    ...
    private void printTree2(Node t, int[] sorted) {
        if (t != null) {
            printTree2(t.left, sorted);
            if(index < sorted.length)
                sorted[index] = t.element;
            index++;
            printTree2(t.right, sorted);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        int[] numbers = {3, 8, 5, 1, 4, 9};
        System.out.println(Arrays.toString(bst.sort(numbers)));
